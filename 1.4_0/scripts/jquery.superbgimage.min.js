            ...
            if(isvideo !== 'true') {
				...
				$(obj).css('position', 'absolute').hide();
					...
					obj.onloadedmetadata = function() {
						...
						//修正延迟时间
						if(options.slide_interval <= obj.duration*1000){
							clearInterval($.superbg_interval);
							$.superbg_interval = setInterval("$(this).nextSlide()", Math.round(obj.duration*1000));
						}
					};
			}
        } else {
